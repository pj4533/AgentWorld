...
class WorldScene: SKScene {
    ...
    private func renderWorld() {
        ...
        for y in 0..<World.size {
            for x in 0..<World.size {
                ...
                let tileNode = createTileNode(for: tileType, size: CGSize(width: tileSize, height: tileSize))
    ...
    private func createTileNode(for tileType: TileType, size: CGSize) -> SKSpriteNode {
